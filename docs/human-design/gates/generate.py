...
def gate_page_html(g):
    ...
    if channels and channels[0]:
        ...
        for ch in channels:
            channels_html += f'          <li><a href="https://humandesignengine.com/human-design/gates/">{ch}</a></li>\n'
        channels_html += "        </ul>"
    else:
...
<link rel="canonical" href="https://humandesignengine.com/human-design/gates/gate-{num}/">
<meta property="og:title" content="{title}">
<meta property="og:description" content="{desc}">
<meta property="og:type" content="article">
<meta property="og:url" content="https://humandesignengine.com/human-design/gates/gate-{num}/">
...
<nav>
  <div class="nav-inner">
    ...
    <div class="nav-links">
      <a href="/human-design/gates/">All Gates</a>
      <a href="/api">API</a>
...
<div class="container">
  ...
  <div class="breadcrumb">
    ...
    <a href="/human-design/gates/">Human Design Gates</a> <span>›</span>
    Gate {num}: {name}
  </div>
...
<link rel="canonical" href="https://humandesignengine.com/human-design/gates/">
...
<meta property="og:url" content="https://humandesignengine.com/human-design/gates/">
...
{{
  ...
  "url": "https://humandesignengine.com/human-design/gates/",
  "publisher": {{ "@type": "Organization", "name": "Human Design Engine", "url": "https://humandesignengine.com" }}
}}
</script>
<style>
...
<nav>
  <div class="nav-inner">
    ...
    <div class="nav-links">
      <a href="/human-design/gates/" style="color:var(--gold-light);">All Gates</a>
      <a href="/api">API</a>
      <a href="/reports">Reports</a>
    </div>
  </div>
