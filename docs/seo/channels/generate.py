...
Output: /home/ubuntu/work/hd-platform/docs/seo/channels/
"""
...
<link rel="canonical" href="https://humandesignengine.com/seo/channels/{canonical_path}">
<meta property="og:title" content="{title}">
<meta property="og:description" content="{meta_desc}">
<meta property="og:type" content="article">
<meta property="og:url" content="https://humandesignengine.com/seo/channels/{canonical_path}">
...
<nav>
  <div class="nav-inner">
    ...
    <ul class="nav-links">
      <li><a href="/">Home</a></li>
      <li><a href="/seo/channels/">All Channels</a></li>
    </ul>
  </div>
</nav>
...
<main class="container">
  <div class="breadcrumb">
    <a href="/">Home</a> &rsaquo; <a href="/seo/channels/">Human Design Channels</a> &rsaquo; Channel {gates} {name}
  </div>
...
"""
        for rc in related:
            ...
            html += f"""      <a href="/seo/channels/{rslug}" class="related-chip">Channel {rgates} &mdash; {rname}</a>
"""
        html += """    </div>
  </div>
"""
...
<footer>
  ...
  <p style="margin-top:8px;"><a href="/seo/channels/">Browse all 36 Human Design Channels</a></p>
</footer>
</body>
</html>"""
    return html
...
<meta name="robots" content="index, follow">
<link rel="canonical" href="https://humandesignengine.com/seo/channels/">
...
<meta property="og:url" content="https://humandesignengine.com/seo/channels/">
<meta property="og:site_name" content="Human Design Engine">
<meta name="twitter:card" content="summary_large_image">
...
"""
    ...
    <p style="color:var(--text-secondary);">"""
        ...
        for c in ch_list:
            ...
            html += f"""      <a href="/seo/channels/{slug}" class="related-chip">Channel {gates} &mdash; {name}</a>\n"""
        html += """    </div>\n"""
