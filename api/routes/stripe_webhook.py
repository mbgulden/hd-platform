...
from shared.hde_email_theme import build_onboarding_email, build_themed_message
...
def send_customer_onboarding_email(email: str, deep_link: str, is_premium: bool) -> bool:
    ...
    subject, body, html = build_onboarding_email(deep_link)
    msg = build_themed_message(
