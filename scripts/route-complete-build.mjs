...
function normalizeLegacyHtmlLinks(contents) {
  return applyEmdashLegacyShell(replaceLegacyDarkInlineStyles(injectCanonicalAnalytics(injectLegacyLightTheme(contents))))
    ...
    .replaceAll('<nav class="nav">', '<nav class="page-subnav nav" style="display: flex; flex-wrap: wrap; align-items: center; justify-content: flex-start; gap: 10px; width: 100%; margin: 24px 0 28px; padding: 14px 16px; text-align: left;">')
